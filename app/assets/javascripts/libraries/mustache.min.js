...
Mustache._render = function(template_id, destination_id, json) {
  template_id = template_id.match('#') == null ? template_id : template_id.replace('#', '');
  destination_id = destination_id.match('#') == null ? destination_id : destination_id.replace('#', '');
  var template = document.getElementById(template_id).innerHTML;
  var html = Mustache.to_html(template, json);
  document.getElementById(destination_id).innerHTML = html;
}
