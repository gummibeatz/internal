...
ActiveRecord::Schema.define(version: 20151028190045) do
  ...
  create_table "clicker_answers", force: :cascade do |t|
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.integer  "developer_id"
    t.integer  "clicker_question_id"
    t.boolean  "is_correct"
    t.integer  "choice"
    t.text     "answer"
  end

  create_table "clicker_questions", force: :cascade do |t|
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.text     "question"
  ...
  create_table "votes", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "clicker_answer_id"
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
  end

  add_index "votes", ["clicker_answer_id"], name: "index_votes_on_clicker_answer_id", using: :btree
  add_index "votes", ["user_id"], name: "index_votes_on_user_id", using: :btree

  add_foreign_key "votes", "clicker_answers"
